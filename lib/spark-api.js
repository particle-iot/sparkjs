...
SparkApi.prototype.defaultHandler = function(eventName, defer, callback) {
  var handler = function(err, response, data) {
    //console.log('err', err);
    err = this.resolveDefer(defer, err, data);
    this.emitAndCallback(eventName, err, data, callback);
  }.bind(this);
...
SparkApi.prototype.login = function (username, password, callback) {
  ...
  var handler = function(err, responses, data) {
     err = this.resolveDefer(defer, err, data, function(data) {
      this.accessToken = data.access_token;
    }.bind(this));

    this.emitAndCallback('login', err, data, callback);
  }.bind(this);
