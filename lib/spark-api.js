 ...
 */
SparkApi.prototype.listDevices = function () {
  var defer = when.defer();
...
SparkApi.prototype.getAttributes = function (coreID, callback) {
  ...
  request({
    ...
    method: "GET",
    json: true
  }, defaultHandler('getAttributes', defer, callback));
...
SparkApi.prototype.getVariable = function (coreID, name, callback) {
  ...
  request({
    ...
    method: "GET",
    json: true
  }, defaultHandler('getVariable', defer, callback));
...
SparkApi.prototype.signalCore = function (coreID, beSignalling, callback) {
  ...
  request({
    ...
    json: true
  }, defaultHandler('signalCore', defer, callback));
...
SparkApi.prototype.flashCore = function (coreID, files, callback) {
  ...
  var r = request({
    ...
    method: "PUT",
    json: true
  }, defaultHandler('flashCore', defer, callback));
