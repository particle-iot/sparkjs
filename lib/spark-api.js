...
SparkApi.prototype = {
  ...
  setup: function(baseUrl, access_token) {
  ...
  login: function (user, pass, callback) {
    this.request({
      uri: this.END_POINTS.login.uri,
      method: this.END_POINTS.login.method,
      form: {
        username: user,
        password: pass,
        grant_type: 'password',
      ...
      json: true
    }, this.callbackHandler('login', callback)); 
  },

  callbackHandler: function(eventName, cb) {
