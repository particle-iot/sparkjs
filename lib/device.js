Device = function (id, attributes, api) {
  this.id = id;
  this._api = api;
...
Device.prototype.emitSignals = function(callback) {
  return this._api.signalCore(this.id, true, callback);
};

Device.prototype.stopSignals = function(callback) {
...
Device.prototype.event = function(eventName, callback) {
